                            ...
                            <div
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src={ singleImage}
                                            alt="Yellow Travel Bag image" class="mx-auto object-cover w-100"/>
                                    </div>
                                </div>

                            </div>
                            <div thumbsSlider="" class="swiper flex product-thumb max-w-[608px] mx-auto">
                                <div class="swiper-wrapper flex">
                                    {
                                        productImages.map((v,i) => {
                                            return(
                                                <div class="swiper-slide" onMouseOver={ () => changeImage(v) }>
                                                    <img src={v} alt="Travel Bag image"
