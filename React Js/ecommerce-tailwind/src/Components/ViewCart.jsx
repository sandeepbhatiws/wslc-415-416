...
import { decrement, increment, removeCart } from './Redux Toolkit/CartSlice';
                        ...
                        <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                          ...
                          <div class="flex items-center justify-between md:order-3 md:justify-end">
                            <div class="flex items-center">
                              ...
                              <button onClick={ () => dispatch(increment(v.id)) } type="button" id="increment-button" data-input-counter-increment="counter-input" class="inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border border-gray-300 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                          ...
                          <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                            <Link to={ `/product-details/${v.id}` } class="text-base font-medium text-gray-900 hover:underline dark:text-white">{v.name}</Link>
                            <p>{v.description}</p>
