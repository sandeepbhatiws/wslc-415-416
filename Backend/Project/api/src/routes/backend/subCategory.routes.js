...
const { viewCategories, create, view, details, update, changeStatus, destroy } = require('../../controllers/backend/subCategory.controller');
...
module.exports = server => {
    ...
    server.use('/api/backend/sub-categories',router);
}