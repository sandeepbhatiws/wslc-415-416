...
exports.create = async (request, response) => {
    ...
    await categoryModal(saveData).save()
    .then((result) => {
        const data = {
            _status : true,
...
exports.view = async(request, response) => {
    ...
    var total_records = await categoryModal.find(filter).countDocuments();

    await categoryModal.find(filter).limit(limit).skip(skip)
